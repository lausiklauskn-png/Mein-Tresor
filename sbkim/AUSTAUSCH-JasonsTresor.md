...
|---|---|---|---|
| **Mein-Tresor** (wir) | `…/Mein-Tresor/sbkim/{AUSTAUSCH-JasonsTresor.md, SIGNAL.json}` | Jasons-Tresor: **2026-06-05** (`SIGNAL.json` seq 2 → `ack["Jasons-Tresor"]=2`) | gegenseitige Spore-Registrierung |
| **Jasons-Tresor** | `…/Jasons-Tresor/sbkim/{…, SIGNAL.json}` | — | unsere abrufbare Spore-URL |
